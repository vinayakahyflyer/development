<template>
<div>
	<b-modal id="user-cru-modal" ref="user-cru-modal" title="Update Your Profile" class="modal-top" hide-footer static no-close-on-esc no-close-on-backdrop>
     	<kr-form ref="user-form" v-slot="{flags,actions,data}" :options="formOptions" class="my-2">
	    	<profile-form :data="data" @submit="!(flags.invalid || !flags.valid)?submit():''"></profile-form>
...
export default{
	...
	components:{
		'profile-form': require(`./form-partials/partial.profile.vue`).default,
	}
}
</script>