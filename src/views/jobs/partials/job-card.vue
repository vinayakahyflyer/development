...
<b-card no-body class="default-border job-card">
    <div class="_p-20px">
        <div class="row">
	        <div :class="{'col-7':hasEditButton&&$can('update','Job'),'col-11':(!hasEditButton||!$can('update','Job'))&&!displayCandidateList,'col-9':(!hasEditButton||!$can('update','Job'))&&displayCandidateList}">
                <div class="row">	
             ...
             <div class="col-sm-3" v-if="displayCandidateList">
                <b-card no-body class="h-100 _px-10px _py-10px indent-shadow job-candidate-list">
                    ...
                    <div class="d-flex">
                        <b-badge pill class="_143px font-weight-semibold short _mb-9px _mr-10px _pl-20px text-left"><i class="ion ion-ios-contacts _mr-10px"></i>DECLINED</b-badge>
             ...
             <div v-if="hasEditButton&&$can('update','Job')" class="col-sm-2" :class="{'offset-sm-2':!displayCandidateList}">
                <div class="d-flex flex-sm-column justify-content-between h-100">
                    <div class="d-flex _mb-20px align-self-start align-self-sm-end">
                        <b-button class=" ml-auto _mr-20px" pill variant="warning"  @click="$event.preventDefault();$emit('edit',job)"> <i class="ion ion-md-create"></i>&nbsp; Edit</b-button>
    ...
    <b-modal v-if="hasEditButton&&$can('update','Job')" id="job-candidate-invite-modal" ref="job-candidate-invite-modal" title="Invite Candidates from another Job" class="modal-top" hide-footer static no-close-on-esc no-close-on-backdrop>
        <kr-form ref="job-candidate-form" v-slot="{flags,actions,data}" :options="formOptions" class="my-2">
            ...
            <b-btn pill variant="success" :block="true" @click="submit()">Invite</b-btn>
        </kr-form>
    </b-modal>
</b-card>
</template>`
