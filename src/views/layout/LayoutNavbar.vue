<template>
  <b-navbar toggleable="lg" :variant="getLayoutNavbarBg()" class="layout-navbar align-items-lg-center container-p-x">
    ...
    <b-navbar-brand to="/" class="app-brand demo d-lg-none py-0 mr-4">
      ...
      <span class="app-brand-text demo font-weight-normal ml-2">Pullman Morrison</span>-->
      <div class="pullman-morrison-topbar-logo">PULLMAN<br/>MORRISON</div>
    </b-navbar-brand>
    ...
    <b-navbar-nav class="layout-sidenav-toggle d-lg-none align-items-lg-center mr-auto" v-if="sidenavToggle">
      <a class="d-md-none d-lg-none nav-item nav-link px-0 mr-lg-4" href="javascript:void(0)" @click="toggleSidenav">
        ...
        <b-nav-item-dropdown :right="!isRTL" class="demo-navbar-user">
          <template slot="button-content">
            <span class="d-inline-flex flex-lg-row-reverse align-items-center align-middle">
              ...
              <span class="px-1 mr-lg-2 ml-2 ml-lg-0">{{krAuth.user().name}}</span>
            </span>
          </template>
          ...
          <b-dd-divider />-->
          <b-dd-item :to="{name:'profile.view'}"><i class="ion ion-ios-person"></i> &nbsp; My Profile</b-dd-item>
          <b-dd-item @click="logout"><i class="ion ion-ios-log-out text-danger"></i> &nbsp; Sign Out</b-dd-item>
